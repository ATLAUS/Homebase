...
export const Dashboard = () => {
  return (
    <div className="h-full overflow-scroll bg-neutral-100">
      ...
      <div className=" mx-9">
        <div className="flex justify-around px-7 py-7">
          <button className="bg-neutral-200 rounded-lg p-1 pl-2 pr-2">
            Previous Week{' '}
          </button>
        ...
        <div className="border border-neutral-200 bg-white">
          ...
          <div className="mx-9 my-5 flex flex-col">
            ...
            <p className="p-2 bg-neutral-100 m-2">
              Move these sections to components
            </p>
          </div>
        </div>
      </div>
